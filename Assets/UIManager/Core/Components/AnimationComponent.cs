...
namespace UIManager
{
    ...
    public class AnimationComponent : MonoBehaviour
    {
        ...
        /// </summary>
        private Dictionary<AnimationExecuteTime, List<AnimationWrapper>> _dictionary;

        /// <summary>
        /// Serialized list of idle animations available for UI elements.
        /// </summary>
        [field: SerializeField] private List<AnimationWrapper> IdleAnimations { get; set; }

        /// <summary>
        /// Serialized list of animations for opening UI elements.
        /// </summary>
        [field: SerializeField] private List<AnimationWrapper> OpenAnimations { get; set; }

        /// <summary>
        /// Serialized list of animations for closing UI elements.
        /// </summary>
        [field: SerializeField] private List<AnimationWrapper> CloseAnimations { get; set; }
        ...
        public Dictionary<AnimationExecuteTime, List<AnimationWrapper>> GetAnimations()
        {
            _dictionary ??= new Dictionary<AnimationExecuteTime, List<AnimationWrapper>>();
        ...
        public void SetAnimation(AnimationExecuteTime executeTime, AnimationWrapper animation, int index = 0)
        {
        ...
        {
            Dictionary<AnimationExecuteTime, List<AnimationWrapper>> dic = GetAnimations();
